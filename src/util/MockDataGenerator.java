...
public class MockDataGenerator {
	...
	private static void crearPacienteConDatos(String nombre, String primerApellido, String segundoApellido, String ci,
		...
		CMF.getInstance().agregarPaciente(nombre, primerApellido, segundoApellido, enfermedades, vacunas, ci, esMujer,
				fecha, direccion);
	}
	...
	private static Analisis generarAnalisisAleatorioParaVisita(LocalDate fechaVisita, int idVisita,
			int idHistoriaClinica, List<Analisis> analisisExistentes) {
	...
	public static void mockData() {
		...
		for (int i = 0; i < visitasDatos.length; i++) {
			...
			// Generar solo un análisis por visita
