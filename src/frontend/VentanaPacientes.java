...
public class VentanaPacientes extends JPanel {
    ...
    public void borrarSeleccion() {
        ...
        if (selectedRows.length > 0) {
            QuestionDialog confirmDialog = new QuestionDialog(
                    ...
                    "驴Est谩 seguro de que desea eliminar la(s) fila(s) seleccionada(s)?"
            );
            ...
            if (confirmDialog.esConfirmado()) {
                for (int i = selectedRows.length - 1; i >= 0; i--) {
                    ...
                    int id = (int) model.getValueAt(modelRow, model.findColumn("H. Cl铆nica"));
                ...
                new InfoDialog(
                        null,
                        "Eliminaci贸n exitosa",
                        "La selecci贸n fue eliminada correctamente."
                ).setVisible(true);
            } else {
                new InfoDialog(
                        null,
    ...
    private void initComponents() {
        ...
        botonEliminar.setToolTipText("Eliminar selecci贸n");
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) { // Double-click detected
                    ...
                    if (viewRow != -1) {
                        int modelRow = table.convertRowIndexToModel(viewRow);
                        int id = (int) model.getValueAt(modelRow, model.findColumn("H. Cl韓ica"));
