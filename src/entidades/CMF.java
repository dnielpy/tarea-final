...
public class CMF {
    ...
    public static CMF getInstance() {
        if (instance == null) {
            instance = new CMF(1, "Policlínico Alberro Cotorro", "Esteban Marrero Bermudez");
    ...
    public void cargarDatos() {
		...
		agregarPaciente(13, "Mar�a Jos�", "Salazar", "Garcia", enfermedades13, vacunas13, "80031722345", true, "05/05/2023");
