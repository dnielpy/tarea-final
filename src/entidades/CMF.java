...
public class CMF {
	private static CMF instance; // Instancia Ãºnica de CMF
	...
	public static CMF getInstance() {
		if (instance == null) {
			instance = new CMF(1, "PoliclÃ­nico Alberro Cotorro", "Esteban Marrero BermÃºdez");
	...
	public void setNombre(String nombre) {
		if (nombre == null || nombre.trim().isEmpty()) throw new IllegalArgumentException("Nombre no puede ser nulo o vacÃ­o");
		if (nombre.length() > 100) throw new IllegalArgumentException("Nombre no puede exceder 100 caracteres");
		this.nombre = nombre.trim();
	}

	public void setNombreDirector(String nombreDirector) {
		if (nombreDirector == null || nombreDirector.trim().isEmpty()) throw new IllegalArgumentException("Nombre del director no puede ser nulo o vacÃ­o");
	...
	public boolean agregarPaciente(int historiaClinicaID, String nombre, String primerApellido, String segundoApellido, ArrayList<String> enfermedadesCronicas, ArrayList<String> vacunacion, String CI, boolean estaEmbarazada, String fechaUltimaRevision) {
		if (!Validations.isValidCI(CI)) {
			throw new IllegalArgumentException("CI invÃ¡lido: " + CI);
		}
	...
	public boolean isCiRepited(String ci) {
		...
		if (ci == null || ci.trim().isEmpty()) {
			throw new IllegalArgumentException("El CI no puede ser nulo o vacÃ­o");
		}
	...
	public ArrayList<Paciente> obtenerEmbarazadasEnRiesgo() {
	    if (pacientes == null) throw new IllegalArgumentException("La lista de pacientes no puede ser nula");    
	    ArrayList<Paciente> embarazadasEnRiesgo = new ArrayList<>();
	    for (Paciente paciente : pacientes) {
	        if (paciente instanceof Mujer) {
	...
	public void cargarDatos() {
		crearMedico("Alfonso", "Rodríguez", "Camela", 11321, "75060212345", "12/3/1998");
		...
		agregarPaciente(1, "Armando", "López", "Toro", enfermedades1, vacunas1, "78041312345", false, null);
		...
		agregarPaciente(2, "Amanda", "López", "García", enfermedades2, vacunas2, "03021178187", false, "15/03/2023");
		...
		agregarPaciente(3, "Carlos", "Garces", "Fernández", enfermedades3, vacunas3, "89041312345", false, null);
		...
		agregarPaciente(4, "Daniela", "Suárez", "Molina", enfermedades4, vacunas4, "95011022345", false, "20/03/2023");
		...
		agregarPaciente(13, "María José", "Salazar", "García", enfermedades13, vacunas13, "80031722345", true, "05/05/2023");
